/**
 * @file Lightweight fake `MemoryClient` for unit tests — implements
 *       just the surface the adapter touches (`search`, `ingest`) and
 *       records every call for assertions. Avoids pulling the real SDK
